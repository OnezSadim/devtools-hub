...
export default function ToolPage() {
  ...
  const process = () => {
    ...
    setOutput('[Four-Square Cipher output for: ' + input.substring(0, 50) + ']')
  }

  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-6">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">Four-Square Cipher</h1>
        <p className="text-gray-400 mb-6">Encrypt and decrypt text using the Four-Square cipher</p>
