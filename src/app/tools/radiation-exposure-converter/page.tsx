...
const UNITS = ["coulomb-per-kilogram", "roentgen", "milliroentgen", "microroentgen"];
const TO_BASE: Record<string, number> = {"coulomb-per-kilogram": 1.0, "roentgen": 0.000258, "milliroentgen": 2.58e-07, "microroentgen": 2.58e-10};
...
export default function Page() {
  ...
  return (
    <main style={{padding:"2rem",fontFamily:"monospace",background:"#0f172a",minHeight:"100vh",color:"#e2e8f0"}}>
      <h1 style={{fontSize:"1.5rem",marginBottom:"1rem"}}>Radiation Exposure Converter</h1>
