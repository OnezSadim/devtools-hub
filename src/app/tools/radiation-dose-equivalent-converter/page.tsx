...
const UNITS: string[] = ["sievert", "rem", "millisievert", "microsievert"];
const TO_BASE: Record<string, number> = {"sievert": 1, "rem": 0.01, "millisievert": 0.001, "microsievert": 1e-06};
...
export default function RadiationDoseEquivalentConverterPage() {
  ...
  return (
    <main style={{maxWidth:480,margin:"40px auto",padding:"0 16px",fontFamily:"sans-serif",color:"#e2e8f0"}}>
      <h1 style={{fontSize:"1.6rem",marginBottom:8}}>Radiation Dose Equivalent Converter</h1>
