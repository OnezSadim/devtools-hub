...
const UNITS = ["sievert", "rem", "millisievert", "microsievert", "millirem", "microrem", "joule/kg"];
const TO_BASE = {"sievert": 1, "rem": 0.01, "millisievert": 0.001, "microsievert": 1e-06, "millirem": 0.0001, "microrem": 1e-07, "joule/kg": 1};

export default function RadiationDoseEquivalentConverterPage() {
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#f1f5f9",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"2rem"}}>
      <h1 style={{fontSize:"2rem",fontWeight:700,marginBottom:"0.5rem"}}>Radiation Dose Equivalent Converter</h1>
