...
const units = [
      { name: 'Henry', symbol: 'H', toBase: 1 },
      { name: 'Millihenry', symbol: 'mH', toBase: 0.001 },
      { name: 'Microhenry', symbol: 'μH', toBase: 1e-06 },
      { name: 'Nanohenry', symbol: 'nH', toBase: 1e-09 },
      { name: 'Picohenry', symbol: 'pH', toBase: 1e-12 }
    ]
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">Convert between inductance units: Henries, Millihenries, Microhenries, Nanohenries, Picohenries.</p>
