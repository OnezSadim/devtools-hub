...
const UNITS = ["Henry (H)", "Millihenry (mH)", "Microhenry (uH)", "Nanohenry (nH)", "Picohenry (pH)"];
const TO_BASE = [1, 0.001, 1e-06, 1e-09, 1e-12];
...
export default function Page() {
  ...
  return (
    <main style={{maxWidth:600,margin:"40px auto",padding:"0 16px",fontFamily:"sans-serif",color:"#e2e8f0",background:"#0f172a",minHeight:"100vh"}}>
      <h1 style={{fontSize:"1.8rem",fontWeight:700,marginBottom:8}}>Inductance Converter</h1>
