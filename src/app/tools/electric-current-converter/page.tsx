...
const UNITS: [string, number][] = [["A", 1], ["mA", 1000], ["µA", 1000000], ["kA", 0.001], ["MA", 1e-06]];

export default function ElectriccurrentconverterConverter() {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      ...
      <p className="text-gray-400 mb-8">Convert between amperes, milliamperes, microamperes, kiloamperes and other current units.</p>
