...
const units = ['A/m', 'kA/m', 'Oe', 'A/cm', 'A/in'];
const factors = {'A/m': 1, 'kA/m': 1000, 'Oe': 79.5775, 'A/cm': 100, 'A/in': 39.3701};
...
export default function Page() {
  ...
  return (
    <main style={{padding:"2rem",fontFamily:"monospace",background:"#0f0f0f",minHeight:"100vh",color:"#e0e0e0"}}>
      <h1 style={{color:"#7c3aed"}}>Magnetic Field Strength Converter</h1>
