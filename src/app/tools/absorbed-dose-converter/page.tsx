...
const UNITS = ["gray", "rad", "milligray", "centigray", "microgray", "millirad", "joule/kg"];
const TO_BASE = {"gray": 1, "rad": 0.01, "milligray": 0.001, "centigray": 0.01, "microgray": 1e-06, "millirad": 0.0001, "joule/kg": 1};
