...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      <h1 className="text-3xl font-bold mb-2">Impedance Converter</h1>
      <p className="text-gray-400 mb-6">Convert between electrical impedance units including ohms, kilohms, and megaohms</p>
