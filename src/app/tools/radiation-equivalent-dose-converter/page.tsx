...
export default function RadiationEquivalentDoseConverterPage() {
  const units: string[] = ["Sievert (Sv)", "Millisievert (mSv)", "Microsievert (uSv)", "Rem", "Millirem (mrem)"];
  const toBase: Record<string, number> = {"Sievert (Sv)": 1, "Millisievert (mSv)": 0.001, "Microsievert (uSv)": 1e-06, "Rem": 0.01, "Millirem (mrem)": 1e-05};
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      <h1 className="text-3xl font-bold mb-2">Radiation Equivalent Dose Converter</h1>
      <p className="text-gray-400 mb-6">Convert between radiation equivalent dose units instantly.</p>
