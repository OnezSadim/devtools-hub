...
const UNITS: string[] = ["W/(m·K)", "BTU/(hr·ft·°F)", "cal/(s·cm·°C)", "kcal/(hr·m·°C)", "mW/(m·K)"];
const TO_BASE: Record<string, number> = {"W/(m·K)": 1.0, "BTU/(hr·ft·°F)": 1.73073, "cal/(s·cm·°C)": 418.68, "kcal/(hr·m·°C)": 1.163, "mW/(m·K)": 0.001};
