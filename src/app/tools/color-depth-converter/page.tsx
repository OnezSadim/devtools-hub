  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-6">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">Color Depth Converter</h1>
        <p className="text-gray-400 mb-8">Convert between color depth formats: bits per pixel, colors, bytes per pixel</p>
