...
const units = ['tesla', 'millitesla', 'microtesla', 'nanotesla', 'gauss', 'milligauss', 'line-per-sq-cm', 'line-per-sq-inch'];
const factors = {'tesla': 1, 'millitesla': 0.001, 'microtesla': 1e-06, 'nanotesla': 1e-09, 'gauss': 0.0001, 'milligauss': 1e-07, 'line-per-sq-cm': 0.0001, 'line-per-sq-inch': 1.55e-05};
