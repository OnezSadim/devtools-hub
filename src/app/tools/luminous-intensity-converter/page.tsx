...
const units: {value:string,label:string,factor:number}[] = [
        { value: 'cd', label: 'Candela (cd)', factor: 1.0 },
        { value: 'kcd', label: 'Kilocandela (kcd)', factor: 1000.0 },
        { value: 'mcd', label: 'Millicandela (mcd)', factor: 0.001 },
        { value: 'ucd', label: 'Microcandela (μcd)', factor: 1e-06 },
        { value: 'HK', label: 'Hefner candle (HK)', factor: 0.9 },
];
...
export default function LuminousIntensityConverterPage() {
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#f1f5f9",display:"flex",flexDirection:"column",alignItems:"center",padding:"40px 16px"}}>
      <h1 style={{fontSize:"2rem",fontWeight:700,marginBottom:8}}>Luminous Intensity Converter</h1>
      <p style={{color:"#94a3b8",marginBottom:32}}>Convert between candela, kilocandela, and millicandela units.</p>
