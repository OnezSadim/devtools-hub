...
const TO_BASE: Record<string, number> = {"candela": 1, "millicandela": 0.001, "kilocandela": 1000, "hefnerkerze": 0.9, "carcel": 9.74};
...
export default function LuminousIntensityConverterPage() {
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#e2e8f0",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"monospace",padding:"2rem"}}>
      <h1 style={{fontSize:"2rem",marginBottom:"1.5rem"}}>Luminous Intensity Converter</h1>
