...
const units = ['Joule per Mol Kelvin (J/mol·K)', 'Kilojoule per Mol Kelvin (kJ/mol·K)', 'Calorie per Mol Kelvin (cal/mol·K)', 'Kilocalorie per Mol Kelvin (kcal/mol·K)', 'BTU per Mol Rankine (BTU/mol·°R)']
  ...
  return (
    <main className='min-h-screen bg-gray-950 text-white p-8'>
      <div className='max-w-xl mx-auto'>
        <h1 className='text-3xl font-bold mb-2'>Molar Entropy Converter</h1>
        <p className='text-gray-400 mb-6'>Convert molar entropy units used in thermodynamics and chemistry.</p>
        <div className='bg-gray-900 rounded-xl p-6 space-y-4'>
          ...
          <div>
            ...
            <select value={from} onChange={e => setFrom(Number(e.target.value))}
              ...
              <option value="4">BTU per Mol Rankine (BTU/mol·°R)</option>
            </select>
          </div>
          <div>
