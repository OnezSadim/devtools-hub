...
const UNITS: string[] = ["Siemens (S)", "Millisiemens (mS)", "Microsiemens (uS)", "Megasiemens (MS)", "Mho"];
const TO_BASE: number[] = [1, 0.001, 1e-06, 1000000.0, 1];
...
export default function ElectricConductanceConverter() {
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#f1f5f9",fontFamily:"monospace",padding:"2rem"}}>
      <h1 style={{fontSize:"1.5rem",marginBottom:"1.5rem"}}>Electric Conductance Converter</h1>
