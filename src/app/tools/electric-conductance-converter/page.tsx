...
const units = ['siemens', 'millisiemens', 'microsiemens', 'kilosiemens', 'megasiemens', 'mho'];
const factors = {'siemens': 1, 'millisiemens': 0.001, 'microsiemens': 1e-06, 'kilosiemens': 1000.0, 'megasiemens': 1000000.0, 'mho': 1};
