...
const units: string[] = ["siemens", "millisiemens", "microsiemens", "abmho", "statmho"];
const toBase: Record<string, number> = {"siemens": 1, "millisiemens": 0.001, "microsiemens": 1e-06, "abmho": 1000000000.0, "statmho": 1.11265e-12};
