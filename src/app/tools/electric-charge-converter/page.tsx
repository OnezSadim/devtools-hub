...
const UNITS = ["Coulomb", "Millicoulomb", "Microcoulomb", "Nanocoulomb", "Picocoulomb", "Kilocoulomb", "Ampere-hour", "Milliampere-hour"];
const FACTORS = [1, 0.001, 1e-06, 1e-09, 1e-12, 1000, 3600, 3.6];
