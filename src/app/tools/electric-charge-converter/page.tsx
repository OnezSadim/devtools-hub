...
const UNITS = ["Coulomb (C)", "Millicoulomb (mC)", "Microcoulomb (uC)", "Nanocoulomb (nC)", "Picocoulomb (pC)", "Ampere-hour (Ah)", "Milliampere-hour (mAh)", "Faraday (F)"];
const TO_BASE = [1, 0.001, 1e-06, 1e-09, 1e-12, 3600, 3.6, 96485.3];
