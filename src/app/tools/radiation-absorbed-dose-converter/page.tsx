...
const UNITS = ["gray", "rad", "milligray", "microgray", "centigray"];
const TO_BASE: Record<string, number> = {"gray": 1.0, "rad": 0.01, "milligray": 0.001, "microgray": 1e-06, "centigray": 0.01};
...
export default function Page() {
  ...
  return (
    <main style={{padding:"2rem",fontFamily:"monospace",background:"#0f172a",minHeight:"100vh",color:"#e2e8f0"}}>
      <h1 style={{fontSize:"1.5rem",marginBottom:"1rem"}}>Radiation Absorbed Dose Converter</h1>
