...
const UNITS = ["Lux (lx)", "Foot-candle (fc)", "Phot (ph)", "Nox", "Millilux (mlx)", "Kilolux (klx)"];
const FACTORS = [1, 10.7639, 10000, 0.001, 0.001, 1000];
...
export default function Page() {
  ...
  return (
    <main style={{padding:"2rem",maxWidth:"600px",margin:"0 auto",fontFamily:"sans-serif",background:"#0f172a",minHeight:"100vh",color:"#f1f5f9"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Illuminance Converter</h1>
