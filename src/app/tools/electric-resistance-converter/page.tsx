...
const units = [
    ...
    { name: 'Kiloohm (kΩ)', factor: 1000 },
    { name: 'Megaohm (MΩ)', factor: 1000000 },
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">Convert between electric resistance units including ohms, kilohms, megaohms, and milliohms.</p>
