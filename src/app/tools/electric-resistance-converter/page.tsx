...
const UNITS: string[] = ["ohm", "milliohm", "microohm", "kilohm", "megohm", "gigohm"];
const TO_BASE: Record<string, number> = {"ohm": 1, "milliohm": 0.001, "microohm": 1e-06, "kilohm": 1000.0, "megohm": 1000000.0, "gigohm": 1000000000.0};
...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-gray-900 text-white p-8">
      <h1 className="text-3xl font-bold mb-6">Electric Resistance Converter</h1>
