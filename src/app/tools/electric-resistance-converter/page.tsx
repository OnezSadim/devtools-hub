...
const UNITS: string[] = ["ohm", "milliohm", "microohm", "kilohm", "megaohm", "gigaohm", "abohm", "statohm"];
const TO_BASE: Record<string, number> = {"ohm": 1, "milliohm": 0.001, "microohm": 1e-06, "kilohm": 1000.0, "megaohm": 1000000.0, "gigaohm": 1000000000.0, "abohm": 1e-09, "statohm": 898755000000.0};
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#f1f5f9",display:"flex",alignItems:"center",justifyContent:"center",padding:"2rem"}}>
      <div style={{background:"#1e293b",borderRadius:"1rem",padding:"2rem",width:"100%",maxWidth:"480px"}}>
        <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1.5rem",textAlign:"center"}}>Electric Resistance Converter</h1>
