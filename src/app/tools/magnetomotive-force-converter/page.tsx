...
const UNITS: string[] = ["Ampere", "Kiloampere", "Milliampere", "Gilbert"];
const TO_BASE: Record<string, number> = {"Ampere": 1.0, "Kiloampere": 1000.0, "Milliampere": 0.001, "Gilbert": 0.795775};
