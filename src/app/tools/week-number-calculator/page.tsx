...
export default function Tool() {
  ...
  const calculate = () => {
    try {
      let output = '';
      const slug = 'week-number-calculator';
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">Week Number Calculator</h1>
        <p className="text-gray-400 mb-6">Find the ISO week number for any date</p>
