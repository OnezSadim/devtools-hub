...
const units = [{name: 'candela/m² (nit)', factor: 1}, {name: 'candela/cm² (stilb)', factor: 10000}, {name: 'candela/ft²', factor: 10.7639}, {name: 'footlambert', factor: 3.42626}, {name: 'lambert', factor: 3183.1}, {name: 'apostilb', factor: 0.31831}, {name: 'millinit', factor: 0.001}, {name: 'kilocandela/m²', factor: 1000}];
...
export default function Page() {
  ...
  return (
    <main style={{maxWidth:600,margin:"40px auto",padding:"0 16px",fontFamily:"sans-serif",color:"#e2e8f0",background:"#0f172a",borderRadius:12,boxShadow:"0 4px 32px #0008"}}>
      <h1 style={{fontSize:28,fontWeight:700,marginBottom:8}}>Luminance Converter</h1>
      <p style={{color:"#94a3b8",marginBottom:24}}>Convert between luminance units: nit, stilb, footlambert, lambert, apostilb and more.</p>
