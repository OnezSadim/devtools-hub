...
const units = ['candela/m2', 'nit', 'stilb', 'lambert', 'foot-lambert', 'millilambert'];
const factors = {'candela/m2': 1.0, 'nit': 1.0, 'stilb': 10000.0, 'lambert': 3183.0988, 'foot-lambert': 3.42626, 'millilambert': 3.18309};
