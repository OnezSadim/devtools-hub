...
const units = ['farad', 'millifarad', 'microfarad', 'nanofarad', 'picofarad', 'femtofarad', 'kilofarad'];
const factors = {'farad': 1, 'millifarad': 0.001, 'microfarad': 1e-06, 'nanofarad': 1e-09, 'picofarad': 1e-12, 'femtofarad': 1e-15, 'kilofarad': 1000.0};
