  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-8">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-2 text-white">Nginx Config Generator</h1>
        <p className="text-gray-400 mb-6">Configure your nginx server block settings below.</p>
