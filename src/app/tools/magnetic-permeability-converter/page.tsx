...
const units = [
    { name: 'H/m', factor: 1.0 },
    { name: 'μH/m', factor: 1e-06 },
    { name: 'nH/m', factor: 1e-09 },
    { name: 'mH/m', factor: 0.001 },
    { name: 'Gs/Oe (relative)', factor: 1.2566370614e-06 },
  ]

export default function Page() {
  const [from, setFrom] = useState('H/m')
  const [to, setTo] = useState('μH/m')
  ...
  return (
    <div style={{maxWidth:480,margin:'40px auto',padding:'24px',fontFamily:'monospace',background:'#111',borderRadius:8,color:'#eee'}}>
      <h1 style={{fontSize:'1.4rem',marginBottom:16}}>Magnetic Permeability Converter</h1>
      <p style={{color:'#aaa',marginBottom:24,fontSize:'0.9rem'}}>Convert magnetic permeability units including H/m and relative permeability.</p>
