...
const UNITS: [string, string, number][] = [['H/m', 'Henry/meter (H/m)', 1.0], ['mu0', 'μ₀ (vacuum)', 1.2566370614e-06], ['CGS', 'CGS (Gs/Oe)', 1.2566370614e-08]];
...
export default function Page() {
  ...
  return (
    <div style={{maxWidth:600,margin:"40px auto",padding:"0 16px",fontFamily:"sans-serif",color:"#e2e8f0",background:"#0f172a",minHeight:"100vh"}}>
      <h1 style={{fontSize:28,fontWeight:700,marginBottom:8}}>Magnetic Permeability Converter</h1>
      <p style={{color:"#94a3b8",marginBottom:24}}>Convert magnetic permeability between H/m, μ₀ units, and CGS equivalents.</p>
