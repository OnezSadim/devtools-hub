...
export default function Page() {
  ...
  return (
    <div className="max-w-2xl mx-auto py-10 px-4">
      <h1 className="text-2xl font-bold mb-2">Tap Code Converter</h1>
      <p className="text-gray-400 mb-6">Convert text to and from tap code used in prisoner communication</p>
      <textarea
