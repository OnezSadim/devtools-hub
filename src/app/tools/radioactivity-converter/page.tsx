...
export default function RadioactivityConverterPage() {
  const units: string[] = ["Becquerel (Bq)", "Kilobecquerel (kBq)", "Megabecquerel (MBq)", "Curie (Ci)", "Millicurie (mCi)"];
  const toBase: Record<string, number> = {"Becquerel (Bq)": 1, "Kilobecquerel (kBq)": 1000, "Megabecquerel (MBq)": 1000000, "Curie (Ci)": 37000000000, "Millicurie (mCi)": 37000000};
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      ...
      <p className="text-gray-400 mb-6">Convert between radioactivity units instantly.</p>
