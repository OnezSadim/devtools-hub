...
const UNITS = ["Bq", "kBq", "MBq", "GBq", "Ci", "mCi", "µCi"];
const TO_BASE: Record<string, number> = {"Bq": 1, "kBq": 1000, "MBq": 1000000.0, "GBq": 1000000000.0, "Ci": 37000000000.0, "mCi": 37000000.0, "µCi": 37000.0};
...
export default function Page() {
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#f1f5f9",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:"2rem"}}>
      <h1 style={{fontSize:"1.8rem",fontWeight:700,marginBottom:"1.5rem"}}>Radioactivity Converter</h1>
