...
const units: { name: string; factor: number }[] = [
  ...
  { name: "rad/min", factor: 0.016666667 },
  { name: "rad/h", factor: 0.000277778 },
  { name: "deg/s", factor: 0.017453293 },
  { name: "deg/min", factor: 0.000290888 },
  { name: "deg/h", factor: 4.848e-06 },
  { name: "rpm", factor: 0.10471976 },
  { name: "rph", factor: 0.001745329 },
...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-gray-100 flex flex-col items-center justify-center p-8">
      ...
      <p className="text-gray-400 mb-8">Convert between angular velocity units</p>
