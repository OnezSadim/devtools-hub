...
const units = ['volt', 'millivolt', 'microvolt', 'kilovolt', 'megavolt', 'abvolt', 'statvolt'];
const factors = {'volt': 1, 'millivolt': 0.001, 'microvolt': 1e-06, 'kilovolt': 1000.0, 'megavolt': 1000000.0, 'abvolt': 1e-08, 'statvolt': 299.792};
...
export default function Page() {
  ...
  return (
    <main style={{padding:"2rem",fontFamily:"monospace",background:"#0f172a",minHeight:"100vh",color:"#e2e8f0"}}>
      <h1 style={{fontSize:"1.5rem",marginBottom:"1rem"}}>Electric Potential Converter</h1>
