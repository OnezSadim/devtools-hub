...
const TO_BASE: Record<string, number> = {"volt": 1, "millivolt": 0.001, "microvolt": 1e-06, "kilovolt": 1000.0, "megavolt": 1000000.0, "abvolt": 1e-08, "statvolt": 299.792458};
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#f1f5f9",display:"flex",alignItems:"center",justifyContent:"center",padding:"2rem"}}>
      <div style={{background:"#1e293b",borderRadius:"1rem",padding:"2rem",width:"100%",maxWidth:"480px"}}>
        <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1.5rem",textAlign:"center"}}>Electric Potential (Voltage) Converter</h1>
