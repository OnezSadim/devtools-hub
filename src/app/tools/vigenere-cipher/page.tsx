...
export default function Vigenère_Cipher_Page() {
  ...
  const process = () => {
    ...
    setOutput('vigenere-cipher ' + mode + 'd: ' + input.split('').map((c, i) => {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-gray-100 p-8">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-gray-400 mb-6">Encrypt and decrypt text using the Vigenère polyalphabetic substitution cipher</p>
