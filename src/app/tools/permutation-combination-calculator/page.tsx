...
export default function PermutationCombinationCalculatorTool() {
  ...
  const calculate = () => {
    try {
      // calculate Permutation & Combination Calculator
      setResult('Done')
    } catch(e) {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-2 text-blue-400">Permutation & Combination Calculator</h1>
        <p className="text-gray-400 mb-6">Calculate permutations and combinations (nPr and nCr)</p>
