...
const UNITS: string[] = ["kg·m²", "g·cm²", "kg·cm²", "lb·ft²", "lb·in²", "oz·in²"];
const FACTORS: Record<string, number> = {"kg·m²": 1, "g·cm²": 1e-07, "kg·cm²": 0.0001, "lb·ft²": 0.04214, "lb·in²": 0.000292639, "oz·in²": 1.829e-05};
