...
export default function Page() {
  const units: string[] = ["steradian", "square-degree", "square-arcminute", "square-arcsecond"];
  const toBase: Record<string, number> = {"steradian": 1, "square-degree": 0.00030462, "square-arcminute": 8.4611e-08, "square-arcsecond": 2.3504e-11};
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      ...
      <p className="text-gray-400 mb-6">Convert between solid angle units instantly.</p>
