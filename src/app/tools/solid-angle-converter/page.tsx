...
export default function Page() {
  const units = ['steradian', 'square degree', 'square arcminute', 'square arcsecond', 'millisteradian'];
  const factors = {'steradian': 1.0, 'square degree': 0.000304617, 'square arcminute': 8.4616e-08, 'square arcsecond': 2.35044e-11, 'millisteradian': 0.001};
