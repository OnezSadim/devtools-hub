...
const UNITS = ["Steradian (sr)", "Square degree (deg2)", "Square arcminute", "Square arcsecond", "Hemisphere", "Full sphere (spat)"];
const FACTORS = [1, 0.000304617, 8.4616e-08, 2.35044e-11, 6.28318, 12.5664];
...
export default function Page() {
  ...
  return (
    <main style={{padding:"2rem",maxWidth:"600px",margin:"0 auto",fontFamily:"sans-serif",background:"#0f172a",minHeight:"100vh",color:"#f1f5f9"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Solid Angle Converter</h1>
