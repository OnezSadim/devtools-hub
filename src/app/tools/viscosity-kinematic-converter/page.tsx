...
const units: string[] = ["m2-per-s", "stokes", "centistokes", "mm2-per-s"];
const toBase: Record<string, number> = {"m2-per-s": 1, "stokes": 0.0001, "centistokes": 1e-06, "mm2-per-s": 1e-06};
...
export default function ViscosityKinematicConverterPage() {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      <h1 className="text-3xl font-bold mb-6">Kinematic Viscosity Converter</h1>
