...
const units = ["kg/m3", "g/cm3", "g/L", "lb/ft3", "lb/in3", "oz/gal"];
const toBase = {"kg/m3": 1, "g/cm3": 1000, "g/L": 1, "lb/ft3": 16.0185, "lb/in3": 27679.9, "oz/gal": 7.48915};
...
export default function DensityConverterPage() {
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#f1f5f9",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"monospace",padding:"2rem"}}>
      <h1 style={{fontSize:"2rem",marginBottom:"1rem"}}>Density Converter</h1>
