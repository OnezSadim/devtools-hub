...
const UNITS = ["weber", "milliweber", "microweber", "maxwell", "volt-second"];
const TO_BASE: Record<string, number> = {"weber": 1, "milliweber": 0.001, "microweber": 1e-06, "maxwell": 1e-08, "volt-second": 1};
