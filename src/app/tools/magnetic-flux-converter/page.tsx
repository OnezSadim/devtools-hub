...
const UNITS = [
      { value: '1', label: 'Weber (Wb)' },
      { value: '1e-8', label: 'Maxwell (Mx)' },
      { value: '1', label: 'Tesla·m² (T·m²)' },
      { value: '1e3', label: 'Kiloweber (kWb)' },
      { value: '1e-3', label: 'Milliweber (mWb)' },
];
...
export default function Page() {
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#f1f5f9",padding:"2rem",fontFamily:"monospace"}}>
      ...
      <p style={{color:"#94a3b8",marginBottom:"2rem"}}>Convert between magnetic flux units: weber, maxwell, tesla square meter.</p>
