...
const UNITS: string[] = ["weber", "milliweber", "microweber", "maxwell", "tesla-m2"];
const TO_BASE: Record<string, number> = {"weber": 1, "milliweber": 0.001, "microweber": 1e-06, "maxwell": 1e-08, "tesla-m2": 1};
