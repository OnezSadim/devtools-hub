...
export default function Page() {
  const units = ["Weber (Wb)", "Milliweber (mWb)", "Maxwell (Mx)", "Tesla-square meter (T·m²)", "Volt-second (V·s)"];
  const toBase = [1, 0.001, 1e-08, 1, 1];
  ...
  return (
    <main style={{maxWidth:600,margin:"40px auto",padding:"0 16px",fontFamily:"monospace",color:"#e2e8f0",background:"#0f172a",borderRadius:12,boxShadow:"0 4px 32px #0008"}}>
      <h1 style={{fontSize:"1.5rem",padding:"24px 0 8px"}}>Magnetic Flux Converter</h1>
