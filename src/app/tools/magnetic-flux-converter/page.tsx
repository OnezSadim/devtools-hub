...
const units = ['weber', 'milliweber', 'microweber', 'tesla-square-meter', 'maxwell', 'kiloweber'];
const factors = {'weber': 1, 'milliweber': 0.001, 'microweber': 1e-06, 'tesla-square-meter': 1, 'maxwell': 1e-08, 'kiloweber': 1000.0};
