...
export default function Page() {
  ...
  return (
    <div style={{maxWidth:'700px',margin:'0 auto',padding:'2rem',fontFamily:'monospace'}}>
      <h1 style={{color:'#e2e8f0',marginBottom:'0.5rem'}}>Fraction to Decimal Converter</h1>
      <p style={{color:'#94a3b8',marginBottom:'1.5rem'}}>Convert fractions to decimals and decimals to fractions</p>
      <textarea
        value={input}
