...
const units: { value: string; label: string; factor: number }[] = [
  ...
  { value: "kgf", label: "Kilogram-force (kgf)", factor: 9.80665 },
  { value: "dyn", label: "Dyne (dyn)", factor: 1e-05 },
  { value: "ozf", label: "Ounce-force (ozf)", factor: 0.278014 },
];
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-8">
      <div className="max-w-xl mx-auto">
        ...
        <p className="text-gray-400 mb-8">Convert between force units: newton, pound-force, kilogram-force, dyne, and more.</p>
