...
const UNITS: string[] = ["sievert", "millisievert", "microsievert", "rem", "millirem"];
const TO_BASE: Record<string, number> = {"sievert": 1, "millisievert": 0.001, "microsievert": 1e-06, "rem": 0.01, "millirem": 1e-05};

export default function EquivalentDoseConverterPage() {
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#e2e8f0",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"monospace",padding:"2rem"}}>
      <h1 style={{fontSize:"2rem",marginBottom:"1.5rem"}}>Equivalent Dose Converter</h1>
