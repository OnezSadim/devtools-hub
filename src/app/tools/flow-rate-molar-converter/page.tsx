...
const units = ['mol/s', 'mol/min', 'mol/h', 'kmol/s', 'kmol/min', 'kmol/h', 'mmol/s', 'mmol/min'];
const factors = {'mol/s': 1.0, 'mol/min': 0.016666666666666666, 'mol/h': 0.0002777777777777778, 'kmol/s': 1000.0, 'kmol/min': 16.666666666666668, 'kmol/h': 0.2777777777777778, 'mmol/s': 0.001, 'mmol/min': 1.6666666666666667e-05};
...
export default function Page() {
  ...
  return (
    <main style={{padding:"2rem",maxWidth:"480px",margin:"0 auto",fontFamily:"sans-serif"}}>
      <h1 style={{fontSize:"1.5rem",marginBottom:"1rem"}}>Molar Flow Rate Converter</h1>
