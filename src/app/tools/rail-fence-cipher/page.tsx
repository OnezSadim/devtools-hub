...
export default function Rail_Fence_Cipher_Page() {
  ...
  const process = () => {
    ...
    setOutput('rail-fence-cipher ' + mode + 'd: ' + input.split('').map((c, i) => {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-gray-100 p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">Rail Fence Cipher</h1>
        <p className="text-gray-400 mb-6">Encrypt and decrypt text using the rail fence transposition cipher</p>
