  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">Leap Year Checker</h1>
        <p className="text-gray-400 mb-6">Check if a year is a leap year and find next leap year</p>
