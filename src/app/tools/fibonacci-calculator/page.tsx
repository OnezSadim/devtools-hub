...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-gray-950 text-white p-8">
      <h1 className="text-3xl font-bold mb-2">Fibonacci Calculator</h1>
      <p className="text-gray-400 mb-6">Calculate Fibonacci numbers, find the nth term, and explore the Fibonacci sequence.</p>
      <textarea
