...
const units = ['V/m', 'kV/m', 'MV/m', 'V/cm', 'V/mm', 'V/in'];
const factors = {'V/m': 1, 'kV/m': 1000, 'MV/m': 1000000.0, 'V/cm': 100, 'V/mm': 1000, 'V/in': 39.3701};
...
export default function Page() {
  ...
  return (
    <main style={{padding:"2rem",fontFamily:"monospace",background:"#0f0f0f",minHeight:"100vh",color:"#e0e0e0"}}>
      <h1 style={{color:"#7c3aed"}}>Electric Field Strength Converter</h1>
