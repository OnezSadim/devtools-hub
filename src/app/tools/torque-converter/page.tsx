...
const UNITS: string[] = ["N·m", "kN·m", "lbf·ft", "lbf·in", "kgf·m", "ozf·in"];
const FACTORS: Record<string, number> = {"N·m": 1, "kN·m": 1000, "lbf·ft": 1.35582, "lbf·in": 0.112985, "kgf·m": 9.80665, "ozf·in": 0.00706155};
