  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-6">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">Print Size Calculator</h1>
        <p className="text-gray-400 mb-8">Calculate print dimensions from pixel dimensions at various DPI settings</p>
