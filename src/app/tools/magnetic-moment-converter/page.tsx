...
const units: [string, number][] = [['A·m²', 1], ['J/T', 1], ['mA·m²', 0.001], ['μA·m²', 1e-06], ['Bohr magneton', 9.2740100783e-24], ['nuclear magneton', 5.0507837461e-27]]
...
export default function Page() {
  ...
  return (
    <main style={{maxWidth:600,margin:'0 auto',padding:'2rem',fontFamily:'sans-serif',color:'#e2e8f0'}}>
      <h1 style={{fontSize:'1.8rem',fontWeight:700,marginBottom:'0.5rem'}}>Magnetic Moment Converter</h1>
      <p style={{color:'#94a3b8',marginBottom:'2rem'}}>Convert magnetic moment units including A·m², J/T, Bohr magneton, and nuclear magneton.</p>
