...
export default function Page() {
  ...
  return (
    <div style={{maxWidth:'700px',margin:'0 auto',padding:'2rem',fontFamily:'monospace'}}>
      <h1 style={{color:'#e2e8f0',marginBottom:'0.5rem'}}>GCD & LCM Calculator</h1>
      <p style={{color:'#94a3b8',marginBottom:'1.5rem'}}>Calculate the Greatest Common Divisor and Least Common Multiple</p>
      <textarea
        value={input}
