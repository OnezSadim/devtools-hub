  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 p-8">
      <div className="max-w-2xl mx-auto">
        <h1 className="text-3xl font-bold mb-2">Regression Calculator</h1>
        <p className="text-gray-400 mb-6">Calculate linear regression, slope, intercept, and R-squared for your data.</p>
        <textarea
