...
const UNITS = ["Lumen (lm)", "Millilumen (mlm)", "Kilolumen (klm)", "Candela-Steradian (cd·sr)", "Lumen/Watt (lm/W) @683nm"];
const FACTORS = [1, 0.001, 1000, 1, 1];
...
export default function Page() {
  ...
  return (
    <main style={{padding:"2rem",maxWidth:"600px",margin:"0 auto",fontFamily:"sans-serif",background:"#0f172a",minHeight:"100vh",color:"#f1f5f9"}}>
      <h1 style={{fontSize:"1.5rem",fontWeight:700,marginBottom:"1rem"}}>Luminous Flux Converter</h1>
