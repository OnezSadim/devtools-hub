...
export default function Page() {
  const units = ["Lumen (lm)", "Candela-steradian (cd·sr)", "Kilolumen (klm)", "Megalumen (Mlm)"];
  const toBase = [1, 1, 1000, 1000000.0];
  ...
  return (
    <main style={{maxWidth:600,margin:"40px auto",padding:"0 16px",fontFamily:"monospace",color:"#e2e8f0",background:"#0f172a",borderRadius:12,boxShadow:"0 4px 32px #0008"}}>
      <h1 style={{fontSize:"1.5rem",padding:"24px 0 8px"}}>Luminous Flux Converter</h1>
