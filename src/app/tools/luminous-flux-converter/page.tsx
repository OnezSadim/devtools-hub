...
const UNITS: string[] = ["Lumen", "Kilolumen", "Millilumen", "Candela-steradian"];
const TO_BASE: Record<string, number> = {"Lumen": 1, "Kilolumen": 1000, "Millilumen": 0.001, "Candela-steradian": 1};
...
export default function Page() {
  ...
  return (
    <main style={{minHeight:"100vh",background:"#0f172a",color:"#f1f5f9",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",fontFamily:"monospace",padding:"2rem"}}>
      <h1 style={{fontSize:"1.8rem",marginBottom:"1.5rem"}}>Luminous Flux Converter</h1>
