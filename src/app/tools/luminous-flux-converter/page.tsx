...
const units = ['lumen', 'kilolumen', 'millilumen', 'candela-steradian', 'foot-lambert-sqft'];
const factors = {'lumen': 1.0, 'kilolumen': 1000.0, 'millilumen': 0.001, 'candela-steradian': 1.0, 'foot-lambert-sqft': 1.0};
