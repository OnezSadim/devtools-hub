...
const UNITS = [
  { label: "Lumen (lm)", factor: 1 },
  { label: "Kilolumen (klm)", factor: 1000 },
  { label: "Millilumen (mlm)", factor: 0.001 },
  { label: "Candela Steradian", factor: 1 },
  { label: "Microlumen (ulm)", factor: 1e-06 },
];
export default function Page() {
  ...
  return (
    <main style={{padding:"2rem",maxWidth:"600px",margin:"0 auto",fontFamily:"monospace",background:"#0f172a",minHeight:"100vh",color:"#e2e8f0"}}>
      <h1 style={{fontSize:"1.5rem",marginBottom:"0.5rem"}}>Luminous Flux Converter</h1>
      <p style={{color:"#94a3b8",marginBottom:"1.5rem"}}>Convert between lumen, kilolumen, millilumen and other luminous flux units.</p>
