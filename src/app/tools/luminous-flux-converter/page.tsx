...
const UNITS: string[] = ["lumen", "candela steradian", "milliLumen", "microLumen"];
const TO_BASE: Record<string, number> = {"lumen": 1, "candela steradian": 1, "milliLumen": 0.001, "microLumen": 1e-06};
...
export default function Page() {
  ...
  return (
    <main className="min-h-screen bg-gray-900 text-white p-8">
      <h1 className="text-2xl font-bold mb-2">Luminous Flux Converter</h1>
      <p className="text-gray-400 mb-6">Convert between luminous flux units.</p>
